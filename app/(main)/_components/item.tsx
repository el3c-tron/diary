...
const Item = ({label, onClick, icon:Icon, id, documentIcon, active, expanded, isSearch, level, onExpand}:ItemProps) => {
    ...
    return (
        <div 
            className={cn("group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground fonr-medium",
        ...
        >
            ...
            {
                isSearch && (
                    <kbd className="ml-auto pointer-events-none inline-flex h-5 select-none items-start gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">
